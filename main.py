...
def main():
    ...
    summary_template = """
        ...
        1. a concise summary of the information in less than 50 words.
        2. two unique facts related to the information.
    """
    summary_prompt_template = PromptTemplate(
        input_variable={"information": information}, template=summary_template
    )
